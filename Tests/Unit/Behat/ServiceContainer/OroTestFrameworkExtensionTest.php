...
namespace Labudzinski\TestFrameworkBundle\Tests\Unit\Behat\ServiceContainer;

use Behat\Symfony2Extension\Suite\SymfonySuiteGenerator;
use Labudzinski\TestFrameworkBundle\Behat\Driver\OroWebDriverCurlService;
use Labudzinski\TestFrameworkBundle\Behat\ServiceContainer\OroTestFrameworkExtension;
...
class OroTestFrameworkExtensionTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @var array
     */
    protected $sharedContexts = ['Labudzinski\TestFrameworkBundle\Tests\Behat\Context\OroMainContext'];
    ...
    public function testProcessBundleAutoload(array $suiteConfig, array $bundlesConfig, array $expectedSuiteConfig)
    {
        ...
        $extension = $this
            ->getMockBuilder('Labudzinski\TestFrameworkBundle\Behat\ServiceContainer\OroTestFrameworkExtension')
    ...
    public function testLoad()
    {
        ...
        $sharedContexts = ['Labudzinski\TestFrameworkBundle\Tests\Behat\Context\OroMainContext'];
            ...
            'OroFormBundle auto configured' => [
                ...
                'expected_suite_config' => [
                    ...
                    'OroFormBundle' => [
                        'type' => 'symfony_bundle',
                        'settings' => [
                            'contexts' => ['Labudzinski\TestFrameworkBundle\Tests\Behat\Context\OroMainContext'],
                            'paths' => ['/Features'],
                        ],
                    ],
                ],
