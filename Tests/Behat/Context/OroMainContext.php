...
namespace Labudzinski\TestFrameworkBundle\Tests\Behat\Context;
...
use Labudzinski\TestFrameworkBundle\Behat\Context\AssertTrait;
use Labudzinski\TestFrameworkBundle\Behat\Context\SessionAliasProviderAwareInterface;
use Labudzinski\TestFrameworkBundle\Behat\Context\SessionAliasProviderAwareTrait;
use Labudzinski\TestFrameworkBundle\Behat\Driver\OroSelenium2Driver;
use Labudzinski\TestFrameworkBundle\Behat\Element\CollectionField;
use Labudzinski\TestFrameworkBundle\Behat\Element\Element;
use Labudzinski\TestFrameworkBundle\Behat\Element\Form;
    ...
    MessageQueueIsolatorAwareInterface
{
     ...
     * @see \Labudzinski\TestFrameworkBundle\Tests\Behat\Context\OroMainContext::switchToActorWindowSession
     *
     ...
     * @see \Labudzinski\TestFrameworkBundle\Tests\Behat\Context\OroMainContext::iOperateAsActorUnderSession
     * @see \Labudzinski\TestFrameworkBundle\Tests\Behat\Context\OroMainContext::sessionsInit
     * @see \Labudzinski\TestFrameworkBundle\Tests\Behat\Context\OroMainContext::loginAsUserWithPasswordInSession
