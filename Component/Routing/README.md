...
services:
    acme.routing_loader:
        class: Labudzinski\TestFrameworkBundle\Component\Routing\Loader\CumulativeRoutingFileLoader
        arguments:
            - @kernel
    ...
    acme.routing_options_resolver:
        class: Labudzinski\TestFrameworkBundle\Component\Routing\Resolver\ChainRouteOptionsResolver
        public: false
```
...
class HiddenRoutesPass implements CompilerPassInterface
{
    ...
    const NEW_MATCHER_DUMPER_CLASS      = 'Labudzinski\TestFrameworkBundle\Component\Routing\Matcher\PhpMatcherDumper';
