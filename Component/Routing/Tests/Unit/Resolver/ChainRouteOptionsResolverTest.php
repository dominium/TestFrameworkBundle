...
use Labudzinski\TestFrameworkBundle\Component\Routing\Resolver\ChainRouteOptionsResolver;
...
class ChainRouteOptionsResolverTest extends \PHPUnit_Framework_TestCase
{
    public function testEmptyChainResolver()
    {
        ...
        $routeCollectionAccessor = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\Routing\Resolver\RouteCollectionAccessor')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testChainResolver()
    {
        ...
        $resolver1 = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Routing\Resolver\RouteOptionsResolverInterface');
        $resolver2 = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Routing\Resolver\RouteOptionsResolverInterface');
