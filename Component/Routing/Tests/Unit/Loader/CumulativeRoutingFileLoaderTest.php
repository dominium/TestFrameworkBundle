...
namespace Labudzinski\TestFrameworkBundle\Component\Routing\Tests\Unit\Loader;

use Labudzinski\TestFrameworkBundle\Component\Routing\Loader\CumulativeRoutingFileLoader;
...
class CumulativeRoutingFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->routeOptionsResolver = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Routing\Resolver\RouteOptionsResolverInterface');
    ...
    public function testLoad()
    {
        ...
        $this->routeOptionsResolver->expects($this->at(0))
            ...
            ->with(
                ...
                $this->isInstanceOf('Labudzinski\TestFrameworkBundle\Component\Routing\Resolver\RouteCollectionAccessor')
            );
