<?php
namespace Labudzinski\TestFrameworkBundle\Component\MessageQueue\Tests\Unit\Client\ConsumptionExtension;

use Labudzinski\TestFrameworkBundle\Component\MessageQueue\Client\ConsumptionExtension\DelayRedeliveredMessageExtension;
