<?php
namespace Labudzinski\TestFrameworkBundle\Component\MessageQueue\Tests\Unit\Consumption\DBAL\Extension;
...
use Labudzinski\TestFrameworkBundle\Component\MessageQueue\Consumption\Dbal\DbalPidFileManager;
use Labudzinski\TestFrameworkBundle\Component\MessageQueue\Consumption\Dbal\Extension\RedeliverOrphanMessagesDbalExtension;
use Labudzinski\TestFrameworkBundle\Component\MessageQueue\Transport\Dbal\DbalConnection;
use Labudzinski\TestFrameworkBundle\Component\MessageQueue\Transport\Dbal\DbalMessageConsumer;
...
class RedeliverOrphanMessagesDbalExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testOnBeforeReceiveShouldThrowIfSessionIsNotDbal()
    {
        ...
        $this->setExpectedException(\LogicException::class, 'Unexpected instance of session. expected:'.
            '"Labudzinski\TestFrameworkBundle\Component\MessageQueue\Transport\Dbal\DbalSession", actual:"Mock_NullSession_');
