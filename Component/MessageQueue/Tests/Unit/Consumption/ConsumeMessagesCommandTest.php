...
use Labudzinski\TestFrameworkBundle\Component\MessageQueue\Consumption\ConsumeMessagesCommand;
...
class ConsumeMessagesCommandTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testShouldThrowExceptionIfProcessorInstanceHasWrongClass()
    {
        ...
        $this->expectExceptionMessage('Invalid message processor service given.'.
            ' It must be an instance of Labudzinski\TestFrameworkBundle\Component\MessageQueue\Consumption\MessageProcessorInterface but stdClass');
