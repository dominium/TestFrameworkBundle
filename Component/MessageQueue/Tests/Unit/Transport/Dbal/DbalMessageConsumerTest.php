...
class DbalMessageConsumerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAcknowledgeShouldThrowIfInstanceOfMessageIsInvalid()
    {
        ...
        $this->expectExceptionMessage(
            ...
            'Labudzinski\TestFrameworkBundle\Component\MessageQueue\Transport\Dbal\DbalMessage '.
            'but it is Labudzinski\TestFrameworkBundle\Component\MessageQueue\Transport\Null\NullMessage.'
        );
