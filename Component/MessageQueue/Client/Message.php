...
class Message
{
     ...
     * @param string|null $priority Can be any value from {@see Labudzinski\TestFrameworkBundle\Component\MessageQueue\Client\MessagePriority)
     */
    ...
    /**
     * @see Labudzinski\TestFrameworkBundle\Component\MessageQueue\Client\MessagePriority
     *
     * @return string
     */
    ...
    /**
     * @param string $priority Can be any value from {@see Labudzinski\TestFrameworkBundle\Component\MessageQueue\Client\MessagePriority)
     *
     * @return self
     */
