...
namespace Labudzinski\TestFrameworkBundle\Component\TestUtils\ORM;

use Doctrine\Common\EventManager;
use Doctrine\DBAL\Driver\Connection;
use Labudzinski\TestFrameworkBundle\Component\TestUtils\ORM\Mocks\DriverMock;
use Labudzinski\TestFrameworkBundle\Component\TestUtils\ORM\Mocks\EntityManagerMock;
use Labudzinski\TestFrameworkBundle\Component\TestUtils\ORM\Mocks\FetchIterator;
...
abstract class OrmTestCase extends \PHPUnit_Framework_TestCase
{
    ...
    protected function getTestEntityManager($conn = null, $eventManager = null, $withSharedMetadata = true)
    {
        ...
        if ($conn === null) {
            $conn = [
                'driverClass'  => 'Labudzinski\TestFrameworkBundle\Component\TestUtils\ORM\Mocks\DriverMock',
                'wrapperClass' => 'Labudzinski\TestFrameworkBundle\Component\TestUtils\ORM\Mocks\ConnectionMock',
                'user'         => 'john',
                'password'     => 'wayne'
            ];
        }
    ...
    {
        $statement = $this->createMock('Labudzinski\TestFrameworkBundle\Component\TestUtils\ORM\Mocks\StatementMock');
    ...
    {
        $countStatement = $this->createMock('Labudzinski\TestFrameworkBundle\Component\TestUtils\ORM\Mocks\StatementMock');
