...
namespace Labudzinski\TestFrameworkBundle\Component\Config\Tests\Unit\Resolver;

use Labudzinski\TestFrameworkBundle\Component\Config\Resolver\SystemAwareResolver;
use Labudzinski\TestFrameworkBundle\Component\Config\Tests\Unit\Fixtures\TestService;
use Labudzinski\TestFrameworkBundle\Component\Routing\Tests\Unit\Resolver\TestResource;
use Symfony\Component\DependencyInjection\ContainerInterface;

class SystemAwareResolverTest extends \PHPUnit_Framework_TestCase
{
    const STATIC_CLASS = 'Labudzinski\TestFrameworkBundle\Component\Config\Tests\Unit\Resolver\SystemAwareResolverTest';
    const CONST1 = 'const1';
    const CONST2 = 'const2';
            ...
            ->will(
                $this->returnValueMap(
                    [
                        ...
                        ['test.class', 'Labudzinski\TestFrameworkBundle\Component\Config\Tests\Unit\Resolver\SystemAwareResolverTest'],
                    ]
                )
            );
        $container->expects($this->any())
