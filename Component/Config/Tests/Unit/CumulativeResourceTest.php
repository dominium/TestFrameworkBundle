...
use Labudzinski\TestFrameworkBundle\Component\Config\CumulativeResource;
use Labudzinski\TestFrameworkBundle\Component\Config\CumulativeResourceManager;
use Labudzinski\TestFrameworkBundle\Component\Config\Loader\CumulativeResourceLoaderCollection;
use Labudzinski\TestFrameworkBundle\Component\Config\Loader\FolderingCumulativeFileLoader;
use Labudzinski\TestFrameworkBundle\Component\Config\Loader\YamlCumulativeFileLoader;
use Labudzinski\TestFrameworkBundle\Component\Config\Tests\Unit\Fixtures\Bundle\TestBundle1\TestBundle1;
use Labudzinski\TestFrameworkBundle\Component\Config\Tests\Unit\Fixtures\Bundle\TestBundle2\TestBundle2;
...
class CumulativeResourceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIsFreshShouldBeCachedIfTimestampWasNotChanged()
    {
        ...
        $resourceLoader = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Config\Loader\CumulativeResourceLoader');
    ...
    public function testIsFreshAllResourcesAreUpToDate()
    {
        ...
        $resourceLoader1 = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Config\Loader\CumulativeResourceLoader');
        $resourceLoader2 = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Config\Loader\CumulativeResourceLoader');
