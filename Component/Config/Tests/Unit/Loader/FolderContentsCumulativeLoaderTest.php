...
use Labudzinski\TestFrameworkBundle\Component\Config\Loader\FolderContentCumulativeLoader;
use Labudzinski\TestFrameworkBundle\Component\Config\Tests\Unit\Fixtures\Bundle\TestBundle1\TestBundle1;
use Labudzinski\TestFrameworkBundle\Component\Config\Tests\Unit\Fixtures\CopyFixturesToTemp;
...
class FolderContentsCumulativeLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLoadInFlatMode(
        ...
        if (!is_array($expectedResult)) {
            ...
            $this->assertInstanceOf('Labudzinski\TestFrameworkBundle\Component\Config\CumulativeResourceInfo', $result);
