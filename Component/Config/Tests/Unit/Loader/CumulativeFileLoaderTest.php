...
use Labudzinski\TestFrameworkBundle\Component\Config\Loader\CumulativeFileLoader;
...
class CumulativeFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function createLoader($relativeFilePath)
    {
        return $this->getMockForAbstractClass(
            'Labudzinski\TestFrameworkBundle\Component\Config\Loader\CumulativeFileLoader',
            [$relativeFilePath]
        );
    }
}
