...
namespace Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\DependencyInjection;

use Doctrine\DBAL\Connection;
use Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\DBAL\ChainTransactionWatcher;
use Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\DBAL\TransactionWatcherAwareInterface;
use Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\DBAL\TransactionWatcherInterface;
use Labudzinski\TestFrameworkBundle\Component\Testing\Doctrine\PersistentConnection;
...
class AddTransactionWatcherCompilerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        // ("Labudzinski\TestFrameworkBundle\Component\Testing\Doctrine\PersistentConnection" for the test environment)
