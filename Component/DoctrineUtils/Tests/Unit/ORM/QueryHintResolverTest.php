...
use Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\ORM\QueryHintResolver;
...
class QueryHintResolverTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testResolveHints()
    {
        ...
        $walkerHintProvider = $this->createMock('Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\ORM\QueryWalkerHintProviderInterface');
