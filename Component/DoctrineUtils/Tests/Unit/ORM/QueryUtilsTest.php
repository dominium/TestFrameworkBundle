...
use Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\ORM\QueryUtils;
...
class QueryUtilsTest extends OrmTestCase
{
    ...
    public function setUp()
    {
        ...
        $metadataDriver = new AnnotationDriver(
            $reader,
            'Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\Tests\Unit\Fixtures\Entity'
        );
        ...
        $this->em->getConfiguration()->setEntityNamespaces(
            [
                'Test' => 'Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\Tests\Unit\Fixtures\Entity'
            ]
        );
    }
    ...
    public function testCreateResultSetMapping()
    {
        ...
        $this->assertInstanceOf(
            'Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\ORM\PlatformResultSetMapping',
            ...
            'query with fully qualified entity name' => [
                function (EntityManager $em) {
                    return $em->createQueryBuilder()
                        ->select('p')
                        ->from('Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\Tests\Unit\Fixtures\Entity\Person', 'p')
                        ->join('p.bestItem', 'i')
                        ->getDQL();
                },
                ['p', 'i'],
    ...
    public function getJoinClassDataProvider()
    {
        return [
            'field:manyToOne' => [
                ...
                ['p', 0],
                'Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\Tests\Unit\Fixtures\Entity\Item',
            ],
            'field:manyToMany' => [
                function (EntityManager $em) {
                    return $em->createQueryBuilder()
                ...
                ['p', 0],
                'Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\Tests\Unit\Fixtures\Entity\Group',
            ],
            ...
            'class:manyToOne' => [
                function (EntityManager $em) {
                    return $em->createQueryBuilder()
                        ->select('p')
                        ->from('Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\Tests\Unit\Fixtures\Entity\Person', 'p')
                        ->join('Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\Tests\Unit\Fixtures\Entity\Item', 'i');
                },
                ['p', 0],
                'Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\Tests\Unit\Fixtures\Entity\Item',
            ],
            'class:manyToMany' => [
                function (EntityManager $em) {
                    return $em->createQueryBuilder()
                        ->select('p')
                        ->from('Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\Tests\Unit\Fixtures\Entity\Person', 'p')
                        ->join('Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\Tests\Unit\Fixtures\Entity\Group', 'g');
                },
                ['p', 0],
                'Labudzinski\TestFrameworkBundle\Component\DoctrineUtils\Tests\Unit\Fixtures\Entity\Group',
            ],
