...
use Labudzinski\TestFrameworkBundle\Component\Action\Action\Configurable;
...
class ConfigurableTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assembler = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\Action\Action\ActionAssembler')
    ...
    {
        $action = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\Action\Action\ActionInterface')
            ->disableOriginalConstructor()
        ...
        $condition = $this->createMock('Labudzinski\TestFrameworkBundle\Component\ConfigExpression\ExpressionInterface');
