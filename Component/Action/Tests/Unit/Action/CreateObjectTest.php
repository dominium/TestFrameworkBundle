...
use Labudzinski\TestFrameworkBundle\Component\Action\Action\CreateObject;
...
class CreateObjectTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function executeDataProvider()
    {
        return [
            'without data' => [
                'options' => [
                    'class'     => 'Labudzinski\TestFrameworkBundle\Component\ConfigExpression\Tests\Unit\Fixtures\ItemStub',
