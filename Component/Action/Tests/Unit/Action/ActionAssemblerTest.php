...
use Labudzinski\TestFrameworkBundle\Component\Action\Action\ActionAssembler;
use Labudzinski\TestFrameworkBundle\Component\Action\Action\ActionFactoryInterface;
use Labudzinski\TestFrameworkBundle\Component\Action\Action\ActionInterface;
use Labudzinski\TestFrameworkBundle\Component\Action\Action\TreeExecutor;
use Labudzinski\TestFrameworkBundle\Component\Action\Tests\Unit\Action\Stub\ArrayAction;
use Labudzinski\TestFrameworkBundle\Component\Action\Tests\Unit\Action\Stub\ArrayCondition;
use Labudzinski\TestFrameworkBundle\Component\ConfigExpression\ExpressionFactory as ConditionFactory;
...
class ActionAssemblerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAssemble(array $source, array $expected)
    {
        ...
        $actionFactory = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Action\Action\ActionFactoryInterface');
        ...
        $conditionFactory = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\ConfigExpression\ExpressionFactory')
        ...
        $configurationPass = $this->getMockBuilder(
            'Labudzinski\TestFrameworkBundle\Component\ConfigExpression\ConfigurationPass\ConfigurationPassInterface'
        ...
        $this->assertInstanceOf('Labudzinski\TestFrameworkBundle\Component\Action\Action\TreeExecutor', $actualTree);
    ...
    {
        $reflection = new \ReflectionProperty('Labudzinski\TestFrameworkBundle\Component\Action\Action\TreeExecutor', 'actions');
    ...
    public function getTreeExecutorMock()
    {
        ...
        $treeExecutor = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\Action\Action\TreeExecutor')
    ...
    protected function getCondition(ActionInterface $postAction)
    {
        ...
        if ($postAction instanceof TreeExecutor) {
            $reflection = new \ReflectionProperty(
                'Labudzinski\TestFrameworkBundle\Component\Action\Action\TreeExecutor',
                'condition'
            );
            $reflection->setAccessible(true);
