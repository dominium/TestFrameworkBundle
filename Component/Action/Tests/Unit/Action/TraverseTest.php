...
use Labudzinski\TestFrameworkBundle\Component\Action\Action\Traverse;
...
class TraverseTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->configurableAction = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\Action\Action\Configurable')
    ...
    {
        $this->expectException('Labudzinski\TestFrameworkBundle\Component\Action\Exception\InvalidParameterException');
