...
use Labudzinski\TestFrameworkBundle\Component\Action\Action\CreateEntity;
...
class CreateEntityTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $stubStorageClass = 'Labudzinski\TestFrameworkBundle\Component\ConfigExpression\Tests\Unit\Fixtures\ItemStub';
    ...
    /**
     * @expectedException \Labudzinski\TestFrameworkBundle\Component\Action\Exception\NotManageableEntityException
    ...
    /**
     * @expectedException \Labudzinski\TestFrameworkBundle\Component\Action\Exception\ActionException
