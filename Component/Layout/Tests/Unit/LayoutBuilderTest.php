...
use Labudzinski\TestFrameworkBundle\Component\Layout\BlockViewCache;
use Labudzinski\TestFrameworkBundle\Component\Layout\Layout;
use Labudzinski\TestFrameworkBundle\Component\Layout\LayoutBuilder;
use Labudzinski\TestFrameworkBundle\Component\Layout\LayoutRegistryInterface;
use Labudzinski\TestFrameworkBundle\Component\Layout\LayoutRendererRegistry;
...
use Labudzinski\TestFrameworkBundle\Component\Layout\Tests\Unit\Stubs\LayoutContextStub;
...
class LayoutBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->rawLayoutBuilder    = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\RawLayoutBuilderInterface');
        $this->layoutManipulator   = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\DeferredLayoutManipulatorInterface');
        $this->blockFactory        = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\BlockFactoryInterface');
        $this->renderer            = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\LayoutRendererInterface');
        ...
        $this->blockViewCache = $this
            ->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\Layout\BlockViewCache')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->layoutBuilder = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\Layout\LayoutBuilder')
            ->setConstructorArgs(
                [
                    $this->registry,
        ...
        $this->layoutBuilderWithoutCache = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\Layout\LayoutBuilder')
            ->setConstructorArgs(
                [
                    $this->registry,
                    $this->rawLayoutBuilder,
    ...
    {
        $rawLayout = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\Layout\RawLayout')->disableOriginalConstructor()->getMock();
        $rootView  = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\Layout\BlockView')->disableOriginalConstructor()->getMock();
        $layout    = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\Layout\Layout')->disableOriginalConstructor()->getMock();
        ...
        $optionValueBag = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\OptionValueBag');
