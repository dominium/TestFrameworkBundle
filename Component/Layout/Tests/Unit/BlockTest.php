...
use Labudzinski\TestFrameworkBundle\Component\Layout\Block;
...
class BlockTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->data       = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\DataAccessorInterface');
