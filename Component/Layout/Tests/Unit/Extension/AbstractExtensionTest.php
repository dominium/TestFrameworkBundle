...
class AbstractExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetType()
    {
        ...
        $this->assertInstanceOf(
            'Labudzinski\TestFrameworkBundle\Component\Layout\BlockTypeInterface',
    ...
    public function testGetTypeExtensions()
    {
        ...
        $this->assertInstanceOf(
            'Labudzinski\TestFrameworkBundle\Component\Layout\BlockTypeExtensionInterface',
    ...
    public function testGetLayoutUpdates()
    {
        ...
        $this->assertInstanceOf('Labudzinski\TestFrameworkBundle\Component\Layout\LayoutUpdateInterface', $layoutUpdates[0]);
    ...
    public function testGetContextConfigurators()
    {
        ...
        $this->assertInstanceOf(
            'Labudzinski\TestFrameworkBundle\Component\Layout\ContextConfiguratorInterface',
            $configurators[0]
        );
    }
     ...
     * @expectedExceptionMessage Expected argument of type "Labudzinski\TestFrameworkBundle\Component\Layout\BlockTypeExtensionInterface", "integer" given.
     */
    ...
    /**
     * @expectedException \Labudzinski\TestFrameworkBundle\Component\Layout\Exception\UnexpectedTypeException
     * @expectedExceptionMessage Expected argument of type "Labudzinski\TestFrameworkBundle\Component\Layout\LayoutUpdateInterface", "integer" given.
     */
    // @codingStandardsIgnoreEnd
    ...
    /**
     * @expectedException \Labudzinski\TestFrameworkBundle\Component\Layout\Exception\UnexpectedTypeException
     * @expectedExceptionMessage Expected argument of type "Labudzinski\TestFrameworkBundle\Component\Layout\ContextConfiguratorInterface", "integer" given.
     */
    // @codingStandardsIgnoreEnd
    ...
    /**
     * @expectedException \Labudzinski\TestFrameworkBundle\Component\Layout\Exception\UnexpectedTypeException
     * @expectedExceptionMessage Expected argument of type "Labudzinski\TestFrameworkBundle\Component\Layout\BlockTypeInterface", "integer" given.
     */
    ...
    protected function getAbstractExtension()
    {
        ...
        $extension = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\BlockTypeExtensionInterface');
    ...
    protected function getLayoutItem($id)
    {
        ...
        $layoutItem->expects($this->any())->method('getContext')
            ->willReturn($this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\ContextInterface'));
