...
namespace Labudzinski\TestFrameworkBundle\Component\Layout\Tests\Unit\Extension\Theme\Model;

use Doctrine\Common\Collections\ArrayCollection;
use Labudzinski\TestFrameworkBundle\Component\Layout\Extension\Theme\Model\PageTemplate;
use Labudzinski\TestFrameworkBundle\Component\Layout\Extension\Theme\Model\ThemeFactory;
use Labudzinski\TestFrameworkBundle\Component\Layout\Extension\Theme\Model\ThemeFactoryInterface;
...
class ThemeManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->factory = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Extension\Theme\Model\ThemeFactoryInterface');
    }
    ...
    public function testGetThemeObject()
    {
        ...
        $themeMock = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Extension\Theme\Model\Theme');
    ...
    public function testGetAllThemes()
    {
        ...
        $theme1Mock = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Extension\Theme\Model\Theme');
        $theme2Mock = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Extension\Theme\Model\Theme');
