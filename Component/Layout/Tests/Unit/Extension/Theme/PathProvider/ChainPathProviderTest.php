...
class ChainPathProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $provider1 = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Extension\Theme\PathProvider\PathProviderInterface');
        $provider2 = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Extension\Theme\PathProvider\PathProviderInterface');
        $provider3 = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Extension\Theme\PathProvider\PathProviderInterface');
    ...
    public function testSetContext()
    {
        ...
        $provider1 = $this
            ->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Extension\Theme\PathProvider\PathProviderInterface');
        $provider2 = $this
