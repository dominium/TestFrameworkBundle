...
class LayoutContextTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @expectedExceptionMessage Failed to resolve the context variables. Reason: The option "test" has invalid type. Expected "Labudzinski\TestFrameworkBundle\Component\Layout\ContextItemInterface", but "stdClass" given.
     */
    ...
    public function testGetData()
    {
        $this->assertInstanceOf(
            'Labudzinski\TestFrameworkBundle\Component\Layout\ContextDataCollection',
            $this->context->data()
        );
    }
