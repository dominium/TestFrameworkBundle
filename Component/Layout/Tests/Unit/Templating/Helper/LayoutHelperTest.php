...
namespace Labudzinski\TestFrameworkBundle\Component\Layout\Tests\Unit\Templating\Helper;

use Labudzinski\TestFrameworkBundle\Component\Layout\BlockView;
use Labudzinski\TestFrameworkBundle\Component\Layout\Form\FormRendererInterface;
use Labudzinski\TestFrameworkBundle\Component\Layout\Form\RendererEngine\FormRendererEngineInterface;
use Labudzinski\TestFrameworkBundle\Component\Layout\Templating\Helper\LayoutHelper;
use Labudzinski\TestFrameworkBundle\Component\Layout\Templating\TextHelper;
...
class LayoutHelperTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->renderer   = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Form\FormRendererInterface');
        $this->textHelper = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\Layout\Templating\TextHelper')
            ->disableOriginalConstructor()
            ->getMock();

        $this->formRenderer = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Form\RendererEngine\FormRendererEngineInterface');
