...
use Labudzinski\TestFrameworkBundle\Component\Layout\LayoutRenderer;
...
class LayoutRendererTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->innerRenderer = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Form\FormRendererInterface');
