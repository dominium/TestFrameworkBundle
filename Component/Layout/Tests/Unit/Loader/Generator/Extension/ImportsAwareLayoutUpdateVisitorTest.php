...
use Labudzinski\TestFrameworkBundle\Component\Layout\Loader\Generator\Extension\ImportsAwareLayoutUpdateVisitor;
...
class ImportsAwareLayoutUpdateVisitorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testVisit()
    {
        ...
        $this->assertSame(
<<<CLASS
class LayoutUpdateWithImport implements \Labudzinski\TestFrameworkBundle\Component\Layout\ImportsAwareLayoutUpdateInterface
{
