...
namespace Labudzinski\TestFrameworkBundle\Component\Layout\Tests\Unit\Loader\Driver;

use Labudzinski\TestFrameworkBundle\Component\Layout\Exception\SyntaxException;
use Labudzinski\TestFrameworkBundle\Component\Layout\Loader\Driver\YamlDriver;
use Labudzinski\TestFrameworkBundle\Component\Layout\Loader\Generator\GeneratorData;
use Labudzinski\TestFrameworkBundle\Component\Layout\Loader\Generator\LayoutUpdateGeneratorInterface;
...
class YamlDriverTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $generator = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Loader\Generator\LayoutUpdateGeneratorInterface');
    ...
    public function testLoadInDebugMode()
    {
        ...
        $this->assertInstanceOf('Labudzinski\TestFrameworkBundle\Component\Layout\LayoutUpdateInterface', $update);
    }
            ...
            ->willReturnCallback(
                function ($className, $data, VisitorCollection $collection) use ($resource) {
                    $this->assertContainsOnlyInstancesOf(
                        'Labudzinski\TestFrameworkBundle\Component\Layout\Loader\Visitor\ElementDependentVisitor',
                        $collection
                    );
...
<?php
    ...
    class $className implements \Labudzinski\TestFrameworkBundle\Component\Layout\LayoutUpdateInterface
    {
...
CLASS;
    ...
    protected function getLoader($generator = null, $debug = false, $cache = false)
    {
        $generator = null === $generator
            ? $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\Loader\Generator\LayoutUpdateGeneratorInterface')
            : $generator;
