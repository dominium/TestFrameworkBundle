...
class RawLayoutTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException \Labudzinski\TestFrameworkBundle\Component\Layout\Exception\ItemNotFoundException
    ...
    {
        $this->expectException('\Labudzinski\TestFrameworkBundle\Component\Layout\Exception\InvalidArgumentException');
    ...
    /**
     * @expectedException \Labudzinski\TestFrameworkBundle\Component\Layout\Exception\ItemAlreadyExistsException
    ...
    // @codingStandardsIgnoreStart
    /**
     * @expectedException \Labudzinski\TestFrameworkBundle\Component\Layout\Exception\AliasAlreadyExistsException
    ...
    /**
     * @expectedException \Labudzinski\TestFrameworkBundle\Component\Layout\Exception\AliasNotFoundException
