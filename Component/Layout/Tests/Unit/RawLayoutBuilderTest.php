...
use Labudzinski\TestFrameworkBundle\Component\Layout\Tests\Unit\Fixtures\Layout\Block\Type\RootType;
...
class RawLayoutBuilderTest extends LayoutTestCase
{
    ...
    {
        $this->expectException('\Labudzinski\TestFrameworkBundle\Component\Layout\Exception\LogicException');
