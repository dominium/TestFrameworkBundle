...
namespace Labudzinski\TestFrameworkBundle\Component\Layout\Tests\Unit\ExpressionLanguage;
...
class ExpressionProcessorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testProcessExpressionsEvaluatesAllExpressions()
    {
        ...
        $data = $this->createMock('Labudzinski\TestFrameworkBundle\Component\Layout\DataAccessorInterface');
    ...
    /**
     * @expectedException \Labudzinski\TestFrameworkBundle\Component\Layout\Exception\CircularReferenceException
