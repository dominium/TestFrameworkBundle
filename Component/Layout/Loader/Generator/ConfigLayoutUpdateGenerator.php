...
use Labudzinski\TestFrameworkBundle\Component\PhpUtils\ReflectionClassHelper;
...
class ConfigLayoutUpdateGenerator extends AbstractLayoutUpdateGenerator
{
    ...
    {
        if (null === $this->helper) {
            $this->helper = new ReflectionClassHelper('Labudzinski\TestFrameworkBundle\Component\Layout\LayoutManipulatorInterface');
        }
