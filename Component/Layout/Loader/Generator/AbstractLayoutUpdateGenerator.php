...
abstract class AbstractLayoutUpdateGenerator implements LayoutUpdateGeneratorInterface
{
    ...
    public function generate($className, GeneratorData $data, VisitorCollection $visitorCollection = null)
    {
        ...
        $class->addInterfaceName('Labudzinski\TestFrameworkBundle\Component\Layout\LayoutUpdateInterface');
        ...
        $manipulatorParameter->setType('Labudzinski\TestFrameworkBundle\Component\Layout\LayoutManipulatorInterface');
        ...
        $layoutItemParameter->setType('Labudzinski\TestFrameworkBundle\Component\Layout\LayoutItemInterface');
