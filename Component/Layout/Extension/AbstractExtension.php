...
namespace Labudzinski\TestFrameworkBundle\Component\Layout\Extension;
...
use Labudzinski\TestFrameworkBundle\Component\Layout\ContextConfiguratorInterface;
use Labudzinski\TestFrameworkBundle\Component\Layout\ContextInterface;
use Labudzinski\TestFrameworkBundle\Component\Layout\Exception;
        ...
        foreach ($loadedLayoutUpdates as $id => $layoutUpdates) {
            ...
            foreach ($layoutUpdates as $layoutUpdate) {
                if (!$layoutUpdate instanceof LayoutUpdateInterface) {
                    throw new Exception\UnexpectedTypeException(
                        $layoutUpdate,
                        'Labudzinski\TestFrameworkBundle\Component\Layout\LayoutUpdateInterface'
                    );
                }
            }
        }
