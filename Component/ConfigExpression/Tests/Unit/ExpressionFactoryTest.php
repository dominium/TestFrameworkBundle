...
use Labudzinski\TestFrameworkBundle\Component\ConfigExpression\ContextAccessorInterface;
use Labudzinski\TestFrameworkBundle\Component\ConfigExpression\ExpressionFactory;
...
use Labudzinski\TestFrameworkBundle\Component\ConfigExpression\Extension\ExtensionInterface;
...
class ExpressionFactoryTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @expectedExceptionMessage Invalid type of expression "test". Expected "Labudzinski\TestFrameworkBundle\Component\ConfigExpression\ExpressionInterface", "stdClass" given.
     */
    ...
    {
        $options = ['key' => 'value'];
        $expr    = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\ConfigExpression\Condition\Blank')
