...
use Labudzinski\TestFrameworkBundle\Component\ConfigExpression\Tests\Unit\Fixtures\ExpressionStub;
...
class ExpressionAssemblerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAssemble($configuration, $expected)
    {
        ...
        $configurationPass =
            $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\ConfigExpression\ConfigurationPass\ConfigurationPassInterface')
