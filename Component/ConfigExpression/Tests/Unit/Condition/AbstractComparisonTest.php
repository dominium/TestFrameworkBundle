...
use Labudzinski\TestFrameworkBundle\Component\ConfigExpression\Condition\AbstractComparison;
...
class AbstractComparisonTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->contextAccessor = $this->createMock('Labudzinski\TestFrameworkBundle\Component\ConfigExpression\ContextAccessorInterface');
        $this->condition       = $this->getMockBuilder('Labudzinski\TestFrameworkBundle\Component\ConfigExpression\Condition\AbstractComparison')
