...
use Labudzinski\TestFrameworkBundle\Component\ConfigExpression\Condition\HasElements;
        ...
        return [
            ...
            [
                ...
                'expected' => '$factory->create(\'has_elements\', ['
                    . 'new \Labudzinski\TestFrameworkBundle\Component\ConfigExpression\CompiledPropertyPath('
