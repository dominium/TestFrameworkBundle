...
namespace Labudzinski\TestFrameworkBundle\Component\ConfigExpression\Tests\Unit\Func;
    ...
    public function compileDataProvider()
    {
        return [
            ...
            [
                ...
                'expected' => '$factory->create(\'value\', ['
                    . 'new \Labudzinski\TestFrameworkBundle\Component\ConfigExpression\CompiledPropertyPath(\'foo\', [\'foo\'], [false])'
                    . ', new \Labudzinski\TestFrameworkBundle\Component\ConfigExpression\CompiledPropertyPath(\'bar\', [\'bar\'], [false])'
                    . '])'
            ],
            [
                'options'  => [new PropertyPath('foo')],
