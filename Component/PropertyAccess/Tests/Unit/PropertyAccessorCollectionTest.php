...
use Labudzinski\TestFrameworkBundle\Component\PropertyAccess\Tests\Unit\Fixtures\Car;
...
abstract class PropertyAccessorCollectionTest extends PropertyAccessorArrayAccessTest
{
    ...
    {
        $car        = $this->createMock('Labudzinski\TestFrameworkBundle\Component\PropertyAccess\Tests\Unit\Fixtures\CompositeCar');
        $structure  = $this->createMock('Labudzinski\TestFrameworkBundle\Component\PropertyAccess\Tests\Unit\Fixtures\CarStructure');
    ...
    {
        $car        = $this->createMock('Labudzinski\TestFrameworkBundle\Component\PropertyAccess\Tests\Unit\Fixtures\CarNoAdderAndRemover');
        $axesBefore = $this->getContainer(array(1 => 'second', 3 => 'fourth'));
        $axesAfter  = $this->getContainer(array(0 => 'first', 1 => 'second', 2 => 'third'));
    ...
    {
        $car = $this->createMock('Labudzinski\TestFrameworkBundle\Component\PropertyAccess\Tests\Unit\Fixtures\Car');
    ...
    {
        $car = $this->createMock('Labudzinski\TestFrameworkBundle\Component\PropertyAccess\Tests\Unit\Fixtures\CarOnlyAdder');
        $axes = $this->getContainer(array(1 => 'first', 2 => 'second', 3 => 'third'));
    ...
    {
        $car = $this->createMock('Labudzinski\TestFrameworkBundle\Component\PropertyAccess\Tests\Unit\Fixtures\CarOnlyRemover');
        $axes = $this->getContainer(array(1 => 'first', 2 => 'second', 3 => 'third'));
