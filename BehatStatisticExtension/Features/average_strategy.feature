Feature: Average strategy
  ...
  Background: Prepare environment
    ...
    And enabled suites in behat.yml:
      ...
      ping_pong:
          contexts:
              - Labudzinski\TestFrameworkBundle\BehatStatisticExtension\TestApp\PingPongContext
          paths: [ Features/ping_pong.feature]
      measurable_features:
          contexts:
              - Labudzinski\TestFrameworkBundle\BehatStatisticExtension\TestApp\FeatureContext
          paths:
