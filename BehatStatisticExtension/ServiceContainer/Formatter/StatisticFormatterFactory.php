...
namespace Labudzinski\TestFrameworkBundle\BehatStatisticExtension\ServiceContainer\Formatter;
...
use Labudzinski\TestFrameworkBundle\BehatStatisticExtension\EventListener\FeatureStatisticSubscriber;
use Labudzinski\TestFrameworkBundle\BehatStatisticExtension\Output\Printer\NullOutputPrinter;
...
final class StatisticFormatterFactory implements FormatterFactory
{
    ...
    private function defineStatisticModels(ContainerBuilder $container)
    {
        $container->setParameter(
            ...
            [
                'Labudzinski\TestFrameworkBundle\BehatStatisticExtension\Model\FeatureStatistic',
            ]
        );
    }
