...
namespace Labudzinski\TestFrameworkBundle\BehatJunitExtension\ServiceContainer;
...
class BehatJunitExtension implements TestworkExtension
{
    ...
    public function process(ContainerBuilder $container)
    {
        $definition = new Definition(
            'Labudzinski\TestFrameworkBundle\BehatJunitExtension\EventListener\JUnitDurationListener'
        );
        ...
        $junitFeaturePrinter->setClass(
            'Labudzinski\TestFrameworkBundle\BehatJunitExtension\Output\Printer\JUnitFeaturePrinter'
        );
        ...
        $junitScenarioPrinter->setClass(
            'Labudzinski\TestFrameworkBundle\BehatJunitExtension\Output\Printer\JUnitScenarioPrinter'
        );
        ...
        $definition = new Definition(
            ...
            [[
                ...
                new Definition(
                    'Labudzinski\TestFrameworkBundle\BehatJunitExtension\EventListener\JUnitFeatureElementListener',
                    [
