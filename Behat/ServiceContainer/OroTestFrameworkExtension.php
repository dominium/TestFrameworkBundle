...
namespace Labudzinski\TestFrameworkBundle\Behat\ServiceContainer;
...
use Labudzinski\TestFrameworkBundle\Behat\Artifacts\ArtifactsHandlerInterface;
use Labudzinski\TestFrameworkBundle\Behat\Driver\OroSelenium2Factory;
use Labudzinski\TestFrameworkBundle\Behat\Driver\OroWebDriverCurlService;
use Labudzinski\TestFrameworkBundle\Behat\Isolation\IsolatorInterface;
...
class OroTestFrameworkExtension implements TestworkExtension
{
    ...
    private function replaceSessionListener(ContainerBuilder $container)
    {
        $container
            ...
            ->setClass('Labudzinski\TestFrameworkBundle\Behat\Listener\SessionsListener');
    }
