...
use Labudzinski\TestFrameworkBundle\Entity\TestActivity;

class TestActivityActivityListProvider implements ActivityListProviderInterface
{
    const ACTIVITY_CLASS = 'Labudzinski\TestFrameworkBundle\Entity\TestActivity';
    const ACL_CLASS = 'Labudzinski\TestFrameworkBundle\Entity\TestActivity';
